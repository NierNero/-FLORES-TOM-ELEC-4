...
const staticMessages = [
    { id: 1, content: "Hello, I need help with my order." },
    { id: 2, content: "Can you provide more details about the product?" },
    { id: 3, content: "I would like to return my purchase." },
];
